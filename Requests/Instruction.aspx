<%@ Page Title="" Language="C#" MasterPageFile="~/Requests-DEV/RequestsMasterPage.master" AutoEventWireup="true" CodeFile="Instruction.aspx.cs" Inherits="Requests_Instruction" validateRequest="false"  MaintainScrollPositionOnPostback="true"  %>
...
<%--<p>In courses where strong research skills are essential, professors may wish to work closely with a librarian to create assignments and schedule multiple library skills sessions carefully placed throughout the semester to introduce research tools and skills gradually, as they are needed.</p>--%>
     ...
     <br />
    <p style="text-align:right;"><b><asp:LinkButton ID="CloseResearchPanel" runat="server" CausesValidation="False" OnClick="ResearchConsultClosePanel_Click" CssClass="close-window-reset">Close X</asp:LinkButton></b></p>
...
<asp:Panel ID="TechnologyInstructionInfoPanel" runat="server" Visible="False" >
     <br />  
   <fieldset>
...
<p></p>
    ...
    <p style="text-align:right;"><b><asp:LinkButton ID="CloseTechPanel" runat="server" CausesValidation="False" OnClick="TechnologyConsultClosePanel_Click" CssClass="close-window-reset">Close X</asp:LinkButton></b></p>
...
<asp:Panel ID="HighSchoolInstructionInfoPanel" runat="server" Visible="False" >
     <br />  
   <fieldset>
<legend>High School Instruction Policies</legend>           

       <h3>Requests</h3>
       <p>Requests for high school class visits should be made by either the high school library media specialist or the teacher of the class visiting the library. 


       </p>
       <p>
           To make a request, please select <strong>"High School" Instruction Type below</strong> and complete the High School Instruction Request form.</p>
       <p>
           In order to integrate your students’ needs with those of our college students, it is necessary that we receive your request&nbsp;form <b>3 weeks in advance</b> of the date requested for the visit. Confirmation for library instruction will be made via e-mail within 7 days of receipt of this form.</p>

       
       <p>
           Unfortunately, due to the lack of classroom space, we will not be able to honor requests for visits during times of peak college use. It is preferable to schedule class visits during breaks when SUNY Geneseo is not in session. If this is not possible, please <a href="mailto:libinstr@geneseo.edu"><strong>email us</strong></a> to discuss a mutually available date. If possible, the high school library media specialist should accompany classes on visits.

           </p>

               <p>
                   For groups of 15 or more students, please bring at least one additional high school staff member.
       </p>
       <p>
           Because our <a href="https://photosynth.net/preview/view/db800991-760d-4fdd-8ec0-93f9ad2df87c" target="_blank"><strong>computer lab <img src="img/question-mark-icon-16.png" /></strong></a> has 40 computers, the <strong>maximum number of students per visit is 40</strong>.
       </p>
       <p>
           Students will be given a one-day username and password that will provide them use of the Library’s computers and free computer printing for the day of their visit.
       </p>

               <p>
                   Please forward a list of student topics to the Library Instruction Coordinator at least 5 days before your visit.
               </p>


           <p>
Please direct all questions regarding visits to <a href="mailto:libinstr@geneseo.edu"><strong>libinstr@geneseo.edu</strong></a></strong>.</p>
 
               
    <h3>Borrowing</h3>
               <p>
                   High school class visits are intended to provide students with on-site use of library resources.
               </p>
               <p>
                   Unfortunately we are unable to lend materials to groups during their visit. Students who are 18 years old may return to the library on their own to obtain a Guest Borrower’s card if they need materials at Geneseo which are not available through the high school’s library media center and interlibrary loan.
               </p>
               <p>
                   Students younger than 18 will need to bring someone older with them in order to borrow materials.
               </p>
               <p>
                   All students should be advised of our return policies and overdue fees of 25 cents per day.
               </p>

                   <p style="text-align:right;">
                       <b>
                       <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" OnClick="HighSchoolConsultClosePanel_Click" CssClass="close-window-reset">Close X</asp:LinkButton>
                       </b>
                   </p>
...
<legend><span class="required">* </span>Please select the Instruction type:</legend>
    ...
    <p style="text-align:right;"><b><asp:LinkButton ID="ResetType" runat="server" CausesValidation="False" OnClick="btnReset_Click" CssClass="close-window-reset">Reset</asp:LinkButton></b></p>
...
<legend>Course Information</legend>
    ...
    <label>Department:</label>
        <asp:DropDownList runat="server" Width="150px" ID="ddlDepartmentActive" />
...
<fieldset>
    ...
    <br /> INTD 105 instructors should note changes in the course description were approved by faculty senate in 2015.&nbsp;<b><br /><br /><a href="https://wiki.geneseo.edu/display/intd105/Course+Guidelines">See the updated guidelines.</a></b>
    <br /><br />
...
<%--    <p><a href="#" id="dialog_link" class="ui-state-default ui-corner-all"><span class="ui-icon ui-icon-newwin"></span>Additional skills/concepts</a></p><br />

    <div id="dialog" title="Additional skills/concepts" >--%>
	<p>While the options offered on the form provide the most frequently requested learning goals and objectives, collaboration and design between teaching faculty and library instructor is always highly encouraged. <br /><br />In order to effectively teach students to obtain the information literacy skills/concepts, please limit your choice to three.  <br /><br />If you need more skills covered, please contact us or consider scheduling an additional session(s).</p>
<%--    </div>--%>
...
<%--    <asp:Panel runat="server" ID="plhDueDate2" Visible="false">
<p><strong>Dates for additional class sessions (if needed):</strong></p>
         <br />--%>
...
<legend>Preparing for & Assessing Student Learning</legend>
  ...
  <label><span class="required">*</span> Instruction geared towards specific assignment?  </label>
    ...
    &nbsp;<asp:requiredfieldvalidator id="rfAssignment" runat="server" errormessage="Required" CssClass="required" controltovalidate="rblAssignment" SetFocusOnError="True" ></asp:requiredfieldvalidator> 
   ...
   <label><span class="required">*</span> Will students already have topics?</label>
    ...
    &nbsp;<asp:requiredfieldvalidator id="rfTopics" runat="server" errormessage="Required" CssClass="required" controltovalidate="rblTopics" SetFocusOnError="True" ></asp:requiredfieldvalidator>&nbsp;  

    <br />

    Further details on the assignment:
    <br />
    <asp:TextBox ID="txtAssignmentDetails" runat="server" Height="75" TextMode="MultiLine" Width="600" TabIndex="36" />
    <br />
    <br />
...
<asp:DropDownList Width="320px" ID="ddlAssessment1" CssClass="dropdown" runat="server" TabIndex="37">
    ...
    &nbsp;<asp:requiredfieldvalidator id="rfAssessment1" runat="server" errormessage="Required" CssClass="required" controltovalidate="ddlAssessment1" SetFocusOnError="True" ></asp:requiredfieldvalidator>
    <br />
...
<legend>Additional information/comments/remarks</legend>
	<asp:TextBox ID="txtComments" runat="server" Height="75" Width="600" TextMode="MultiLine" TabIndex="43"/>
    <br /><br />
...
<%--* Please use this form to request high school class instructions, after referring to <br />the <a href="http://www.geneseo.edu/library/high-school-class-visits-policies"><strong>High School Class Visits Policies</strong></a><strong>. </strong>
        <br /> <br />
        Your request will be routed to an appropriate library instructor. <br /><br /><b>Our computer lab can accommodate 40 students. <br /><br />Additional students must bring laptop computers.</b> <br /><br />

<p>All requests should be made by the library media specialist with <br /><b>at least 3 weeks advance notice</b>. Confirmation for library instruction<br />will be made via e-mail within 7 days of receipt of this form.</p> <br />--%>
...
<legend>Course Information</legend>
    ...
    <label><span class="required">*</span> Teacher's First Name: </label> <asp:TextBox runat="server" size="25" maxlength="25" ID="txtTeacherFirstName" />
    &nbsp; <asp:requiredfieldvalidator id="rfTeacherFirstName" runat="server" errormessage="Required" CssClass="required" controltovalidate="txtTeacherFirstName" SetFocusOnError="True"></asp:requiredfieldvalidator><br />
     
    <label><span class="required">*</span> Teacher's Last Name: </label><asp:TextBox runat="server" size="25" maxlength="50" ID="txtTeacherLastName" /> 
    &nbsp; <asp:requiredfieldvalidator id="rfTeacherLastName" runat="server" errormessage="Required" CssClass="required" controltovalidate="txtTeacherLastName" SetFocusOnError="True"></asp:requiredfieldvalidator>
<br />
   ...
   <asp:requiredfieldvalidator id="rfSchoolStudentNumber" runat="server" errormessage="Required" CssClass="required" controltovalidate="txtSchoolStudentNumber" SetFocusOnError="True" ></asp:requiredfieldvalidator>
<br />
    ...
    <br /> <asp:TextBox ID="txtSchoolAssignment" runat="server"  TextMode="MultiLine" Height="75" Width="600" /><br />
</fieldset>
    <br />
...
<br />   
    ...
    <label><span class="required">*</span> Arrival Time: </label> <asp:TextBox CssClass="time" ID="txtArrivalTime" runat="server" size="11" maxlength="11" /> 
    &nbsp; <asp:requiredfieldvalidator id="rfArrivalTime" runat="server" errormessage="Required" CssClass="required" controltovalidate="txtArrivalTime" SetFocusOnError="True" ></asp:requiredfieldvalidator><br />
    
    <label><span class="required">*</span> Departure Time: </label> <asp:TextBox CssClass="time" ID="txtDepartureTime" runat="server" size="11" maxlength="11" /> 
    &nbsp; <asp:requiredfieldvalidator id="rfDepartureTime" runat="server" errormessage="Required" CssClass="required" controltovalidate="txtDepartureTime" SetFocusOnError="True" ></asp:requiredfieldvalidator><br />
</fieldset>
    <br />
...
<legend>Instruction Needs</legend>
    ...
    Which resources (databases, subject specific resources, collections, etc.) would you like your students to be introduced to at Milne Library?&nbsp;<br /><asp:TextBox ID="txtInstructionNeeds" runat="server" Height="75" TextMode="MultiLine" Width="600" />
    <br />
    <br />
