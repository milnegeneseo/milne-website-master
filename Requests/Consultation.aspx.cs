...
public partial class Requests_Consultation : System.Web.UI.Page
{
    ...
    public void BindDropdownlists()
    {
        ...
        dt = ReferenceInstructionDropdownClass.getPatronType();
    ...
    protected void btnResearchConsultSubmit_Click(object sender, EventArgs e)
    {
        ...
        mailMessage.From = new MailAddress("libinstr@geneseo.edu");
        mailMessage.To.Add("libinstr@geneseo.edu, reference-desk-googlegroup@geneseo.edu");
        ...
        sb.AppendFormat("Project Description: {0}" + Environment.NewLine + Environment.NewLine, txtDescription.Text.Trim());
        sb.AppendFormat("Suggested Days/Times: {0}" + Environment.NewLine + Environment.NewLine, txtDates.Text.Trim());
