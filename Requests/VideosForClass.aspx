<%@ Page Title="" Language="C#" MasterPageFile="~/Requests-DEV/RequestsMasterPage.master" AutoEventWireup="true" CodeFile="VideosForClass.aspx.cs" Inherits="Requests_Videos" validateRequest="false" %>
...
<div id="" >
    ...
    <p>We recommend that requests be submitted as far ahead of time as possible (a week or more advance notice is recommended). The pick-up point for DVDs and videos is located at Milne Service Desk. <br /><br />

* If you need a DVD or video more than once during the semester, you may want to consider placing the DVD or video on reserve to guarantee its availability when needed. </p> <br />
...
<fieldset>
    ...
    <asp:RadioButtonList ID="rblType" runat="server" RepeatDirection="Horizontal" CssClass="rbl" >
