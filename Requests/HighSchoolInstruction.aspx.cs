...
public partial class Requests_HighSchoolInstruction : System.Web.UI.Page
{
 ...
 //   {
    ...
    //    string query = "INSERT INTO [AllFields] ([InstructionType], [CourseProfFirstN], [CourseProfLastN], [Email], [Phone], [PlannedNumStudents], [isCollege], [CourseNum], [CourseTitle], [Department], [AssGroupProgram], [NonCollWorkTitle], [LibSkillConcept1], [LibSkillConcept2], [LibSkillConcept3], [LibGoalsDetails], [Date], [Time], [LibHSEndTime], [LibGearTowards], [LibHaveTopics], [LibAssessDetails], [LibAssessStrat1], [LibAssessStrat2], [Comments], [FormType], [Librarian1], [Librarian2], [QuestionFormat], [Minutes], [Librarian1PrepTime], [Librarian2PrepTime], [StudFeedMinutes], [ServiceType]) VALUES (@InstructionType, @FirstN, @LastN, @Email, @Phone, @StudentNumber, @isCollege, @CourseNum, @CourseTitle, @Department, @AssocicatedGroup, @WorkshopTitle, @SkillConcept1, @SkillConcept2, @SkillConcept3,  @Date, @StartTime, @EndTime, @GearTowards, @HaveTopics, @AssessDetails, @Comments, @FormType, @Librarian1, @Librarian2, @QuestionFormat, @Minutes, @PrepTime1, @PrepTime2, @FeedMinutes, @ServiceType)";

     /*      if (!string.IsNullOrEmpty(txtDueDate2.Text))
        {
            query += "INSERT INTO [AllFields] ([InstructionType], [CourseProfFirstN], [CourseProfLastN], [Email], [Phone], [PlannedNumStudents], [isCollege], [CourseNum], [CourseTitle], [Department], [AssGroupProgram], [NonCollWorkTitle], [LibSkillConcept1], [LibSkillConcept2], [LibSkillConcept3], [LibGoalsDetails], [Date], [Time], [LibHSEndTime], [LibGearTowards], [LibHaveTopics], [LibAssessDetails], [LibAssessStrat1], [LibAssessStrat2], [Comments], [FormType], [Librarian1], [Librarian2], [QuestionFormat], [Minutes], [Librarian1PrepTime], [Librarian2PrepTime], [StudFeedMinutes], [ServiceType]) VALUES (@InstructionType, @FirstN, @LastN, @Email, @Phone, @StudentNumber, @isCollege, @CourseNum, @CourseTitle, @Department, @AssocicatedGroup, @WorkshopTitle, @SkillConcept1, @SkillConcept2, @SkillConcept3,  @Date2, @StartTime, @EndTime, @GearTowards, @HaveTopics, @AssessDetails, @Comments, @FormType, @Librarian1, @Librarian2, @QuestionFormat, @Minutes, @PrepTime1, @PrepTime2, @FeedMinutes, @ServiceType)";
        }

        if (!string.IsNullOrEmpty(txtDueDate3.Text))
        {
            query += "INSERT INTO [AllFields] ([InstructionType], [CourseProfFirstN], [CourseProfLastN], [Email], [Phone], [PlannedNumStudents], [isCollege], [CourseNum], [CourseTitle], [Department], [AssGroupProgram], [NonCollWorkTitle], [LibSkillConcept1], [LibSkillConcept2], [LibSkillConcept3], [LibGoalsDetails], [Date], [Time], [LibHSEndTime], [LibGearTowards], [LibHaveTopics], [LibAssessDetails], [LibAssessStrat1], [LibAssessStrat2], [Comments], [FormType], [Librarian1], [Librarian2], [QuestionFormat], [Minutes], [Librarian1PrepTime], [Librarian2PrepTime], [StudFeedMinutes], [ServiceType]) VALUES (@InstructionType, @FirstN, @LastN, @Email, @Phone, @StudentNumber, @isCollege, @CourseNum, @CourseTitle, @Department, @AssocicatedGroup, @WorkshopTitle, @SkillConcept1, @SkillConcept2, @SkillConcept3,  @Date3, @StartTime, @EndTime, @GearTowards, @HaveTopics, @AssessDetails,  @Comments, @FormType, @Librarian1, @Librarian2, @QuestionFormat, @Minutes, @PrepTime1, @PrepTime2, @FeedMinutes, @ServiceType)";
        }

        if (!string.IsNullOrEmpty(txtDueDate4.Text))
        {
            query += "INSERT INTO [AllFields] ([InstructionType], [CourseProfFirstN], [CourseProfLastN], [Email], [Phone], [PlannedNumStudents], [isCollege], [CourseNum], [CourseTitle], [Department], [AssGroupProgram], [NonCollWorkTitle], [LibSkillConcept1], [LibSkillConcept2], [LibSkillConcept3], [LibGoalsDetails], [Date], [Time], [LibHSEndTime], [LibGearTowards], [LibHaveTopics], [LibAssessDetails], [LibAssessStrat1], [LibAssessStrat2], [Comments], [FormType], [Librarian1], [Librarian2], [QuestionFormat], [Minutes], [Librarian1PrepTime], [Librarian2PrepTime], [StudFeedMinutes], [ServiceType]) VALUES (@InstructionType, @FirstN, @LastN, @Email, @Phone, @StudentNumber, @isCollege, @CourseNum, @CourseTitle, @Department, @AssocicatedGroup, @WorkshopTitle, @SkillConcept1, @SkillConcept2, @SkillConcept3,  @Date4, @StartTime, @EndTime, @GearTowards, @HaveTopics, @AssessDetails,  @Comments, @FormType, @Librarian1, @Librarian2, @QuestionFormat, @Minutes, @PrepTime1, @PrepTime2, @FeedMinutes, @ServiceType)";
        }

      if (!string.IsNullOrEmpty(txtDueDate5.Text))
        {
            query += "INSERT INTO [AllFields] ([InstructionType], [CourseProfFirstN], [CourseProfLastN], [Email], [Phone], [PlannedNumStudents], [isCollege], [CourseNum], [CourseTitle], [Department], [AssGroupProgram], [NonCollWorkTitle], [LibSkillConcept1], [LibSkillConcept2], [LibSkillConcept3], [LibGoalsDetails], [Date], [Time], [LibHSEndTime], [LibGearTowards], [LibHaveTopics], [LibAssessDetails], [LibAssessStrat1], [LibAssessStrat2], [Comments], [FormType], [Librarian1], [Librarian2], [QuestionFormat], [Minutes], [Librarian1PrepTime], [Librarian2PrepTime], [StudFeedMinutes], [ServiceType]) VALUES (@InstructionType, @FirstN, @LastN, @Email, @Phone, @StudentNumber, @isCollege, @CourseNum, @CourseTitle, @Department, @AssocicatedGroup, @WorkshopTitle, @SkillConcept1, @SkillConcept2, @SkillConcept3,  @Date5, @StartTime, @EndTime, @GearTowards, @HaveTopics, @AssessDetails,  @Comments, @FormType, @Librarian1, @Librarian2, @QuestionFormat, @Minutes, @PrepTime1, @PrepTime2, @FeedMinutes, @ServiceType)";
        }

        if (!string.IsNullOrEmpty(txtDueDate6.Text))
        {
            query += "INSERT INTO [AllFields] ([InstructionType], [CourseProfFirstN], [CourseProfLastN], [Email], [Phone], [PlannedNumStudents], [isCollege], [CourseNum], [CourseTitle], [Department], [AssGroupProgram], [NonCollWorkTitle], [LibSkillConcept1], [LibSkillConcept2], [LibSkillConcept3], [LibGoalsDetails], [Date], [Time], [LibHSEndTime], [LibGearTowards], [LibHaveTopics], [LibAssessDetails], [LibAssessStrat1], [LibAssessStrat2], [Comments], [FormType], [Librarian1], [Librarian2], [QuestionFormat], [Minutes], [Librarian1PrepTime], [Librarian2PrepTime], [StudFeedMinutes], [ServiceType]) VALUES (@InstructionType, @FirstN, @LastN, @Email, @Phone, @StudentNumber, @isCollege, @CourseNum, @CourseTitle, @Department, @AssocicatedGroup, @WorkshopTitle, @SkillConcept1, @SkillConcept2, @SkillConcept3, @Date6, @StartTime, @EndTime, @GearTowards, @HaveTopics, @AssessDetails,  @Comments, @FormType, @Librarian1, @Librarian2, @QuestionFormat, @Minutes, @PrepTime1, @PrepTime2, @FeedMinutes, @ServiceType)";
        }

        if (!string.IsNullOrEmpty(txtDueDate7.Text))
        {
            query += "INSERT INTO [AllFields] ([InstructionType], [CourseProfFirstN], [CourseProfLastN], [Email], [Phone], [PlannedNumStudents], [isCollege], [CourseNum], [CourseTitle], [Department], [AssGroupProgram], [NonCollWorkTitle], [LibSkillConcept1], [LibSkillConcept2], [LibSkillConcept3], [LibGoalsDetails], [Date], [Time], [LibHSEndTime], [LibGearTowards], [LibHaveTopics], [LibAssessDetails], [LibAssessStrat1], [LibAssessStrat2], [Comments], [FormType], [Librarian1], [Librarian2], [QuestionFormat], [Minutes], [Librarian1PrepTime], [Librarian2PrepTime], [StudFeedMinutes], [ServiceType]) VALUES (@InstructionType, @FirstN, @LastN, @Email, @Phone, @StudentNumber, @isCollege, @CourseNum, @CourseTitle, @Department, @AssocicatedGroup, @WorkshopTitle, @SkillConcept1, @SkillConcept2, @SkillConcept3, @Date7, @StartTime, @EndTime, @GearTowards, @HaveTopics, @AssessDetails,  @Comments, @FormType, @Librarian1, @Librarian2, @QuestionFormat, @Minutes, @PrepTime1, @PrepTime2, @FeedMinutes, @ServiceType)";
        }

        if (!string.IsNullOrEmpty(txtDueDate8.Text))
        {
            query += "INSERT INTO [AllFields] ([InstructionType], [CourseProfFirstN], [CourseProfLastN], [Email], [Phone], [PlannedNumStudents], [isCollege], [CourseNum], [CourseTitle], [Department], [AssGroupProgram], [NonCollWorkTitle], [LibSkillConcept1], [LibSkillConcept2], [LibSkillConcept3], [LibGoalsDetails], [Date], [Time], [LibHSEndTime], [LibGearTowards], [LibHaveTopics], [LibAssessDetails], [LibAssessStrat1], [LibAssessStrat2], [Comments], [FormType], [Librarian1], [Librarian2], [QuestionFormat], [Minutes], [Librarian1PrepTime], [Librarian2PrepTime], [StudFeedMinutes], [ServiceType]) VALUES (@InstructionType, @FirstN, @LastN, @Email, @Phone, @StudentNumber, @isCollege, @CourseNum, @CourseTitle, @Department, @AssocicatedGroup, @WorkshopTitle, @SkillConcept1, @SkillConcept2, @SkillConcept3, @Date8, @StartTime, @EndTime, @GearTowards, @HaveTopics, @AssessDetails, @Comments, @FormType, @Librarian1, @Librarian2, @QuestionFormat, @Minutes, @PrepTime1, @PrepTime2, @FeedMinutes, @ServiceType)";
        }
 */
...
/*         sb.AppendFormat("Formal Assessment Strategy #1: {0}" + Environment.NewLine + "    ", ddlAssessment1.SelectedValue);
    ...
    protected void HSbtnSubmit_Click(object sender, EventArgs e)
    {
        ...
        cmd.Parameters.AddWithValue("@InstructionType", "High School");
        ...
        Response.Redirect("HighSchoolInstructionThankYou.aspx");
    }

    protected void CancelButton_Click(object sender, EventArgs e)
    {
        Server.Transfer("HighSchoolInstruction.aspx");
        ClearFields(Page);
