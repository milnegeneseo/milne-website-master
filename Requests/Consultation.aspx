...
<%--<span class="span-indent-gold">How can a
    <asp:LinkButton ID="ResearchConsultInfoPanelLink" runat="server" CausesValidation="False" OnClick="ResearchConsultInfoPanelLink_Click">Research Consultation</asp:LinkButton> help me? &nbsp;&nbsp;&nbsp; How can a
    <asp:LinkButton ID="TechnologyConsultInfoPanelLink" runat="server" CausesValidation="False" OnClick="TechnologyConsultInfoPanelLink_Click">Technology Consultation</asp:LinkButton> help me?
</span>--%>
...
<p>A research consultation is a one-on-one meeting with a reference librarian in which the focus is your research project.</p>
 <p>A research consultation can help with:</p>
    <ul><li>Getting started on a research project (e.g., identifying a topic, discovering basic research tools)</li>
     ...
     <br />
    <p style="text-align:right;"><b><asp:LinkButton ID="CloseResearchPanel" runat="server" CausesValidation="False" OnClick="ResearchConsultClosePanel_Click"  CssClass="close-window-reset">Close X</asp:LinkButton></b></p><br />
...
<asp:Panel ID="TypePanel" runat="server" Visible="True" >
    <br />
<fieldset>
...
<legend>Personal Information</legend>
    ...
    &nbsp;<asp:requiredfieldvalidator id="rfMajor" runat="server" errormessage="Required" CssClass="required" controltovalidate="ddlMajor" SetFocusOnError="True" ></asp:requiredfieldvalidator> 
    <br />
...
<legend>Assignment Information</legend>
    ...
    <label><span class="required">*</span> Assignment Due Date (mm/dd/yyyy): </label>
        <asp:TextBox CssClass="date" ID="txtDueDate" runat="server" size="11" maxlength="11" />
    ...
    &nbsp;<asp:requiredfieldvalidator id="rfResearchCollege" runat="server" errormessage="Required" CssClass="required" controltovalidate="rblResearchCollege" SetFocusOnError="True" > </asp:requiredfieldvalidator> 
    <br />
    ...
    <label>Department:</label>
        <asp:DropDownList runat="server" ID="ddlDepartmentActive" />
    ...
    <span class="required">*</span> <strong>Describe your project/paper in as much detail as possible. </strong>
    <br />
    Please include the number of pages required, and type of material you must use <br />(such as scholarly journals, web sites, newspapers, etc.). 
        <br />&nbsp;&nbsp;<asp:RequiredFieldValidator ID="rfDescription" runat="server" controltovalidate="txtDescription" CssClass="required" errormessage="Required" SetFocusOnError="True"></asp:RequiredFieldValidator>
    <br />
    <asp:TextBox ID="txtDescription" runat="server" Height="75" TextMode="MultiLine" Width="600" />
    <br />
    <br />
    ...
    <br />
    <asp:TextBox ID="txtDates" runat="server" Height="75" TextMode="MultiLine" Width="600" />
    <%--<asp:TextBox ID="txtCurrentDate" runat="server" Visible="False"></asp:TextBox>
    <asp:TextBox ID="txtCurrentTime" runat="server" Visible="False"></asp:TextBox>--%>
    <br />
    <br />
...
&nbsp;
  ...
  <!--Ende Research Consultation Panel -->  
...
<legend>Personal Information</legend>
    ...
    <label><span class="required">*</span> Status/Class Standing: </label>
        <asp:DropDownList ID="ddlTechnologyStatus" runat="server" AppendDataBoundItems="True" />
    &nbsp; <asp:requiredfieldvalidator id="rfTechnologyStatus" runat="server" errormessage="Required" CssClass="required" controltovalidate="ddlTechnologyStatus" SetFocusOnError="True" ></asp:requiredfieldvalidator>
    <br />

    <label><span class="required">*</span> Major: </label>
        <asp:DropDownList ID="ddlTechnologyMajor" runat="server" AppendDataBoundItems="True" />          
    &nbsp;<asp:requiredfieldvalidator id="rfTechnologyMajor" runat="server" errormessage="Required" CssClass="required" controltovalidate="ddlTechnologyMajor" SetFocusOnError="True" ></asp:requiredfieldvalidator> 
    <br />
...
<legend>Assignment Information</legend>
    ...
    <label><span class="required">*</span> Assignment Due Date (mm/dd/yyyy): </label>
        <asp:TextBox CssClass="date" ID="txtTechnologyDueDate" runat="server" size="11" maxlength="11" />
    &nbsp;<asp:requiredfieldvalidator id="rfTechnologyDueDate" runat="server" errormessage="Required" CssClass="required" controltovalidate="txtTechnologyDueDate" SetFocusOnError="True" ></asp:requiredfieldvalidator>&nbsp; 
    ...
    &nbsp;<asp:requiredfieldvalidator id="rfTechnologyCollege" runat="server" errormessage="Required" CssClass="required" controltovalidate="rblTechnologyCollege" SetFocusOnError="True" > </asp:requiredfieldvalidator> 
    <br />
    ...
    <label>Department:</label>
        <asp:DropDownList runat="server" ID="ddlTechnologyDepartmentActive" />
    ...
    <span class="required">*</span> Describe your project in as much detail as possible. <strong>
    <br />
    Include any software you may need assistance with.</strong> &nbsp;&nbsp;<asp:RequiredFieldValidator ID="rfTechnologyDescription" runat="server" controltovalidate="txtTechnologyDescription" CssClass="required" errormessage="Required" SetFocusOnError="True"></asp:RequiredFieldValidator>
    <br />
    <asp:TextBox ID="txtTechnologyDescription" runat="server" Height="75" TextMode="MultiLine" Width="600" />
    <br />
    <br />
    ...
    <br />
    <asp:TextBox ID="txtTechnologyDates" runat="server" Height="75" TextMode="MultiLine" Width="600" />
    <%--<asp:TextBox ID="txtTechnologyCurrentDate" runat="server" Visible="False"></asp:TextBox>
    <asp:TextBox ID="txtTechnologyCurrentTime" runat="server" Visible="False"></asp:TextBox>--%>
    <br />
    <br />
